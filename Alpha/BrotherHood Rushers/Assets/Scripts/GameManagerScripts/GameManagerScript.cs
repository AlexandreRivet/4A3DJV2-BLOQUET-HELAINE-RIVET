...
public class GameManagerScript : MonoBehaviour {
	...
	public void removeActionPlayers(int id, int index)
	{
		_pileActionPlayers[id].removeActionPlayerAt(index);
	}
	public int comparePositionActionPlayers(int id,float position)
	{
		return _pileActionPlayers[id].comparePositionActionToAllActionInPile(position);
	}
